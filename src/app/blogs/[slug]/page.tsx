      ...
      <main className="flex-1">
        <article className="relative overflow-hidden bg-bg pt-32 pb-16 text-fg lg:pt-40 lg:pb-24">
          <div className="relative z-10 mx-auto max-w-3xl px-6 lg:px-10">
            ...
            <p className="mt-8 text-xs uppercase tracking-[0.3em] text-fg/50">
              {post.date}
            </p>
            ...
            <div className="mt-14 border-t border-fg/10 pt-8">
              <Link
                href="/blogs"
                className="inline-flex items-center gap-2 border-b border-fg/40 pb-1 text-sm font-medium text-fg transition-colors hover:border-fg"
              >
                <ArrowLeft className="h-4 w-4" strokeWidth={1.5} />
                Back to Blogs
              </Link>
